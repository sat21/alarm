...
class Timer(tk.Frame):
    def __init__(self, parent):
        ...
        self.hours_frame = tk.LabelFrame(self.spinbox_frame,
                                         text="Başlangıç saatini ayarlayın:")
        ...
        self.minutes_frame = tk.LabelFrame(self.spinbox_frame,
                                           text="Başlangıç dakikalarını ayarlayın:")
        ...
        self.seconds_frame = tk.LabelFrame(self.spinbox_frame,
                                           text="Başlangıç saniyelerini ayarlayın:")
        ...
        self.active_button = tk.Button(self.button_frame, text="başla",
                                       command=self.start)
        self.stop_button = tk.Button(self.button_frame, text="sıfırla",
                                     command=self.stop)
    ...
    def start(self):
        ...
        self.clock = tk.Label(self, text=self.time_remaining,
                              font=Font(family='Helvetica', size=36,
                                        weight='bold'))
        self.active = True
        self.active_button.config(text="duraklat", command=self.pause)
    ...
    def pause(self):
        self.active = False
        self.active_button.config(text="devam", command=self.resume)
